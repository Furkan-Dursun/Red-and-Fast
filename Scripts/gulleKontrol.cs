...
public class gulleKontrol : MonoBehaviour
{
    ...
    void noktalaraGit()
    {
        ...
        transform.position += aradakiMesafe * Time.deltaTime * 1;  //testerenin pozisyonunu aradakimesafeyi ekleyip yeni pozisyonuna gitmesini sagladik
...
[CustomEditor(typeof(gulleKontrol))]
[System.Serializable]
class gulleKontrolEditor : Editor
{
    public override void OnInspectorGUI()
    {
        gulleKontrol script = (gulleKontrol)target;
