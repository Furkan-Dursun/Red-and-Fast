...
public class testere : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        transform.Rotate(0, 0, 5); // testereyi donduruyoruz
        noktalaraGit();
    }
    ...
    void noktalaraGit()
    {
        ...
        transform.position += aradakiMesafe * Time.deltaTime * 10;  //testerenin pozisyonunu aradakimesafeyi ekleyip yeni pozisyonuna gitmesini sagladik
