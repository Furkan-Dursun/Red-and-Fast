...
public class anaMenuDusman : MonoBehaviour
{
    ...
    void noktalaraGit()
    {
        ...
        transform.position += aradakiMesafe * Time.deltaTime * 2;  //testerenin pozisyonunu aradakimesafeyi ekleyip yeni pozisyonuna gitmesini sagladik
...
[CustomEditor(typeof(anaMenuDusman))]
[System.Serializable]
class anaMenuDusmanEditor : Editor
{
    public override void OnInspectorGUI()
    {
        anaMenuDusman script = (anaMenuDusman)target;
